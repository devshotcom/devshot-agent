...
# devshot:exposed_ports=[{"port":8080,"name":"editor","proto":"http"},{"port":${port},"name":"${app}","proto":"http"}]
...
#
# Two exposed ports — editor (:8080) is the primary entry, AppsTab
...
# for preview. openvscode-server itself lives in lamp-shared so this
# layer just sets the workspace via set_editor_workspace inside
# install_<app>.
